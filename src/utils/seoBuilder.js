// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
// ZOKASCORE — SEO Builder (Cleaned & Optimized)
// Single source of truth for meta, structured data & breadcrumbs
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

export const SITE = Object.freeze({
  name: "ZOKASCORE",
  url: "https://zokascore.xyz",
  description: "Football predictions, live scores, fixtures, match analysis & statistics from leagues worldwide. Free soccer tips, H2H, standings & results.",
  image: "https://zokascore.xyz/og-image.png",
  keywords: "football predictions, soccer predictions, live scores, fixtures today, premier league predictions, la liga, champions league, match analysis, H2H, standings, results, ZOKASCORE, free football tips, soccer stats",
  locale: "en_GB",
  twitter: "@zokascore",
  themeColor: "#05070a",
...
export const seoGenerators = {
  matchPage({
    ...
    return buildSEO({
      ...
      description: `${homeName} vs ${awayName} — live score, prediction, head-to-head stats, lineups and match analysis. ${isLive ? 'LIVE NOW!' : isFinished ? 'Final result.' : 'Kickoff ' + (date ? new Date(date).toLocaleString('en-GB', { day: 'numeric', month: 'short', hour: '2-digit', minute: '2-digit' }) : 'TBD')}`,
  ...
  leaguePage({ leagueName, path, leagueLogo }) {
    return buildSEO({
      ...
      description: `Live ${leagueName} standings, fixtures, results, top scorers and statistics. Updated in real-time.`,
      keywords: `${leagueName}, ${leagueName} standings, ${leagueName} fixtures, ${leagueName} table, results`,
      path,
      structuredData: {
        "@context": "https://schema.org",
        "@type": "SportsLeague",
  ...
  teamPage({ teamName, path, teamLogo, country, venue }) {
    return buildSEO({
      title: `${teamName} Fixtures, Results & Stats`,
      description: `Latest fixtures, form, results, standings and statistics for ${teamName}. Full schedule and match history.`,
