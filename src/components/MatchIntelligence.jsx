    ...
    <div className="zoka-card" style={{ padding: '20px', marginTop: '20px' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{ display: 'flex', height: '8px', borderRadius: '4px', overflow: 'hidden', background: '#1e293b' }}>
          <div style={{ width: `${winProbability.home}%`, background: '#10b981', transition: 'width 1s ease' }} />
          <div style={{ width: `${winProbability.draw}%`, background: '#64748b', transition: 'width 1s ease' }} />
          <div style={{ width: `${winProbability.away}%`, background: '#ef4444', transition: 'width 1s ease' }} />
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '6px', fontSize: '0.8rem', fontWeight: 700 }}>
          <span style={{ color: '#10b981' }}>{winProbability.home}%</span>
          <span style={{ color: '#64748b' }}>{winProbability.draw}%</span>
          <span style={{ color: '#ef4444' }}>{winProbability.away}%</span>
        </div>
      </div>
