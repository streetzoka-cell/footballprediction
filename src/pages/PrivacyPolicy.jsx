    ...
    <div className="info-page">
      <SEO
        {...buildSEO({
          ...
          description:
            "Read the ZOKASCORE Privacy Policy to understand how we collect, use, and protect your personal data while you enjoy our football prediction services.",
          keywords:
            "privacy policy, data protection, ZOKASCORE privacy, user data, cookie policy",
          path: "/privacy",
          robots: "index,follow",
        })}
      />
        ...
        <div className="info-content-box">
          ...
          <div className="info-section">
            ...
            <p className="info-section-text">
              ...
              preferences. Disabling cookies may affect some features of the
              platform.
            </p>
          </div>
