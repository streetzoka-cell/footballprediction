    ...
    <div className="zoka-page">
      ...
      <div className="zoka-wrap">
        ...
        <h2 className="text-primary font-bold mb-12 flex-center gap-8" style={{justifyContent: 'flex-start'}}>
          <Calendar size={18} /> Upcoming Matches
        </h2>
        ...
        <div className="glass-card p-20 mb-24">
          {fixturesLoading ? (
            ...
            <p className="text-muted text-center p-20">No upcoming matches found for this team in the current window.</p>
          ) : (
        ...
        <div className="glass-card p-20 mb-24">
          {historicalResults.length > 0 ? (
            ...
            <p className="text-muted text-center p-20">No historical results found in the archive.</p>
          )}
        </div>
