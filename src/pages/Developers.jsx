...
const endpoints = [
  {
    method: 'GET',
    path: '/api/v1/data/live.json',
    desc: 'Real-time live scores, match minutes, and basic stats for all in-play matches globally.',
    format: 'JSON Array'
  },
  {
    method: 'GET',
    path: '/api/v1/data/fixtures/{date}.json',
    desc: 'Scheduled fixtures and pre-match data for a specific date (YYYY-MM-DD).',
    format: 'JSON Array'
  },
  {
    method: 'GET',
    path: '/api/v1/data/results/{date}.json',
    desc: 'Final scores and historical results for a specific date (YYYY-MM-DD).',
    format: 'JSON Array'
  },
  {
    method: 'GET',
    path: '/api/v1/match/{matchId}',
    desc: 'Canonical Match Object. Aggregates live data, historical intelligence, Elo, Form, and H2H into one unified payload.',
    format: 'JSON Object'
  },
  {
    method: 'GET',
    path: '/api/v1/intelligence/team/{teamName}',
    desc: 'Deep Team Intelligence. Returns overall form, goal patterns (Over 2.5%, BTTS%), and resilience stats.',
    format: 'JSON Object'
  },
  {
    method: 'GET',
    path: '/api/v1/intelligence/h2h/{teamA}/{teamB}',
    desc: 'Head-to-Head Intelligence. All-time meetings, wins, draws, and goal markets between two specific teams.',
    format: 'JSON Object'
  }
];
...
const EndpointCard = ({ ep }) => {
  ...
  return (
    <div className="glass-card p-20 mb-16 flex-col gap-12">
      ...
      <div className="bg-elevated p-12 rounded-md flex-between items-center gap-8 mt-4">
        <div className="flex-center gap-8 text-muted text-xs font-mono overflow-x-auto whitespace-nowrap">
...
export default function Developers() {
  return (
    <div className="zoka-page">
      ...
      <div className="zoka-wrap" style={{ maxWidth: 900 }}>
        ...
        <section className="text-center mb-40 mt-20">
          <div className="glass-card flex-center mb-16 mx-auto" style={{ width: '64px', height: '64px', borderRadius: '16px', background: 'rgba(var(--primary-rgb), 0.1)' }}>
            <Code size={32} className="text-primary" />
          </div>
          <h1 className="text-primary font-extrabold text-3xl mb-12">ZOKASCORE API</h1>
          <p className="text-muted text-lg max-w-600 mx-auto leading-relaxed">
        ...
        <section className="mb-40">
          <h2 className="text-primary font-bold text-xl mb-16 flex-center gap-8" style={{ justifyContent: 'flex-start' }}>
            <Database size={20} /> Data Coverage & Infrastructure
          </h2>
        ...
        <section className="mb-40">
          <h2 className="text-primary font-bold text-xl mb-16 flex-center gap-8" style={{ justifyContent: 'flex-start' }}>
            <ShieldCheck size={20} /> Prediction Performance & Audit
          </h2>
          <div className="glass-card p-24 border-l-4" style={{ borderColor: 'var(--gold)' }}>
            ...
            <div className="grid gap-12" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))' }}>
              <div className="bg-elevated p-12 rounded-md">
        ...
        <section className="mb-40">
          <h2 className="text-primary font-bold text-xl mb-16 flex-center gap-8" style={{ justifyContent: 'flex-start' }}>
            <Terminal size={20} /> Example Usage
          </h2>
          <div className="glass-card p-20">
            <p className="text-muted text-sm mb-12">
              Fetch live scores directly from your terminal or application:
            </p>
            <div className="bg-elevated p-16 rounded-md font-mono text-sm text-secondary overflow-x-auto">
        ...
        <section className="text-center mt-40 mb-40">
          ...
          <p className="text-muted text-sm mb-16 max-w-500 mx-auto">
