...
async function main() {
  console.log('============================================================');
  console.log(' ZOKASCORE V2 PIPELINE — STEP 30C');
  console.log(' HISTORICAL WALK-FORWARD BACKTEST');
  console.log('============================================================\n');
  ...
  const sample = allMatches.slice(-SAMPLE_SIZE); 
  console.log(`> Sampling ${sample.length.toLocaleString()} matches for backtesting...\n`);
  ...
  for (let i = 0; i < sample.length; i++) {
    ...
    if ((i + 1) % 1000 === 0) {
      ...
      process.stdout.write(`\r   Processed ${i + 1}/${sample.length} (${elapsed}s)...`);
    }
    ...
    try {
      ...
      logLossBtts += actualBtts ? -Math.log(Math.max(pred.probabilities.btts / 100, eps)) : -Math.log(Math.max(pred.probabilities.bttsNo / 100, eps));
  ...
  console.log(`\n\n> Backtest complete in ${elapsedTotal}s`);
  ...
  console.log('============================================================');
  console.log(' BACKTEST RESULTS (POISSON BASELINE)');
  console.log('============================================================');
  ...
  console.log('\n============================================================');
  console.log(' STEP 30C COMPLETE');
  console.log('============================================================');
  console.log('This establishes the historical Poisson baseline.');
