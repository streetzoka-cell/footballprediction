...
print("🧠 ZOKASCORE V2 - Pipeline 43.1: Signal Fusion & Similarity (Clean)")
print("=" * 60)
print()
...
# 4. DEFINE FINAL FEATURE SET (32 Features)
# NOTE: "elo_diff" is removed to prevent duplication with "elo_diff_signed"
FEATURE_COLUMNS = [
    # Core ELO (2)
...
# 6. TRAIN MODEL
print("\n⚡ Training XGBoost (Balanced + Clean Signal Fusion)...")
