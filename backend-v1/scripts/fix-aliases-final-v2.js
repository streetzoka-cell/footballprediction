...
const FIXES = {
  ...
  "law_05_referee": {
    aliases: ["referee", "advantage", "whistle", "injury", "caution", "sent off", "disciplinary"],
  ...
  "law_12_fouls_misconduct": {
    ...
    keywords: ["handball", "backpass", "violent", "score with your hand"]
  },
  "law_13_free_kicks": {
  ...
  "law_14_penalty_kick": {
    ...
    keywords: ["penalty spot", "encroaches", "goalkeeper line", "twice", "moves early"]
  },
  "law_16_goal_kick": {
  ...
  "law_17_corner_kick": {
    aliases: ["corner kick", "corner arc", "corner flag", "from a corner"],
...
console.log('🎉 Definitive alias fix v2 complete!');