// footballprediction/backend-v1/src/services/UnifiedFixtureService.js
...
async function buildUnifiedFixtures(date) {
  ...
  logger.info(`[Unifier] âœ“ Linked ${commonCount} common matches. Total unified: ${unifiedMap.size}`);
