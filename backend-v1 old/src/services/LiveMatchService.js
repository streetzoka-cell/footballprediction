// footballprediction/backend-v1/src/services/LiveMatchService.js
  ...
  try {
    ...
    for (let fixture of fixtures) {
      ...
      if (liveMatch) {
        ...
        // â˜… FIX: Force FT if it's been live for > 3.5 hours, even if API says it's still 1H/2H
        if (isExpired) {
          fixture.status = 'FT';
      ...
      // 2. If match is NOT currently live
        ...
        // â˜… SMART TIME CHECK: If it started > 3.5 hours ago, force it to FT
