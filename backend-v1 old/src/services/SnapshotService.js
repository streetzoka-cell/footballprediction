...
async function writeFootballSnapshot(dateStr, updates) {
  try {
    ...
    // 2. Save to Firestore
    // âš ï¸ FIRESTORE DISABLED DUE TO NODE v22 gRPC HANG âš ï¸
    ...
    // â˜… NEW SAFETY CHECK: Only overwrite results if we actually have results!
    ...
    logger.info(`[SnapshotService] âœ“ Fully complete for ${dateStr}.`);
