// footballprediction/backend-v1/src/routes/v1/monitoring/dashboard.js
const express = require('express');
const router = express.Router();
const ProviderManager = require('../../../providers/ProviderManager');
const memoryCache = require('../../../cache/MemoryCache');
const logger = require('../../../utils/logger');
const QuotaManager = require('../../../services/QuotaManager'); // â˜… NEW IMPORT
...
router.get('/metrics', (req, res) => {
  const cacheStats = memoryCache.stats();
  const quota = QuotaManager.getStats(); // â˜… GET QUOTA STATS
